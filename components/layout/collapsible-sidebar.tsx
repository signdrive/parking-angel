...
import { MapPin, Bookmark, History, Settings, Bot, ChevronLeft, ChevronRight, LogOut, User } from "lucide-react"
...
export function CollapsibleSidebar({ activeTab, onTabChange, className }: CollapsibleSidebarProps) {
