...
import { GoogleMapsNavigation } from "./google-maps-navigation"
...
export function NavigationInterface({ onExit }: NavigationInterfaceProps) {
  ...
  // Voice instructions
  useEffect(() => {
    if (currentRoute && settings.voiceGuidance) {
      // Voice guidance logic would go here
    }
  }, [currentRoute, settings.voiceGuidance])
  ...
  return <GoogleMapsNavigation onExit={onExit} />
}
