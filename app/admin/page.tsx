  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <AdminSidebar
        ...
        onCenterMap={() => {
          // This will be called when the center map button is clicked
          toast({
            title: "Map Centering",
            description: "Centering map on your current location...",
          })
        }}
      />
            ...
            <div className="h-full">
              <Card className="h-full">
                <CardHeader>
                  ...
                  <CardDescription>Real-time parking spot monitoring with automatic location centering</CardDescription>
                </CardHeader>
